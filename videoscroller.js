    ...
    var pluginName = 'VideoScroller',
        defaults = {
            ...
            onInit: function () {
                ...
                this.options.scrollerContent.css("opacity", "0");
            },
            ...
            onVideoLoaded: function (currentlyPlayingIndex) {
                console.log("onVideoLoaded This: ");
                console.log(this);
            ...
            videojs(self.options.videoPlayerId, {
                ...
                function () {
                    ...
                    self.videoPlayer.on("loadeddata", function () {
                        self.options.onVideoLoaded.call(self, self.currentlyPlayingIndex);
                    });
            ...
            this.scrollTimer = setInterval(function () {
                ...
                if (currentWidth >= (parentWidth - widthInterval)) {
                    ...
                    if (currentWidth >= (parentWidth - (widthInterval * 2))) {
                        self.options.onLoadingVideo.call(self, self.currentlyPlayingIndex);
                    }
